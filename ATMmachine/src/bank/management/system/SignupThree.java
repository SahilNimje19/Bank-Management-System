...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        carddetail.setFont(new Font("Ralway", Font.BOLD, 12 ));
        carddetail.setBounds(100, 330,300 ,12);
        add(carddetail);
        ...
        pindetail.setFont(new Font("Ralway", Font.BOLD, 12 ));
        ...
        c7 = new JCheckBox("I herely declare that the above entered details are correct to knowledge :  ",true);
